...
export const Chapter1_2: FC = () => (
  <Root>
    ...
    <ContentWrapper>
      ...
      <Text>
        1.
        functionを使って、引数として与えられた文字列を逆順にしてlogに出力する関数を作成してください。
      </Text>
      <Text>
        2.
        アロー関数を使って、引数として与えられた二つの数値を掛け合わせてlogに出力する関数を作成してください。
      </Text>
      <Text>
        3.アロー関数を使って、引数として与えられた数値の配列の中で最大値をlogに出力する関数を作成してください。
      </Text>
    </ContentWrapper>
  </Root>
)
